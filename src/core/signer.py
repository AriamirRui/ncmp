...
from .exceptions import CANCELLED_REASON, TaskCancelledError, sleep_interruptible


class Signer:
    def __init__(self, session: requests.Session, task_id: str, logger: Logger,
                 config: Config, cancel_event=None):
        ...
        try:
            ...
            if response["code"] == 200:
                ...
                if "频繁" in error_msg:
                    ...
                    sleep_interruptible(retry_delay, self.cancel_event)
